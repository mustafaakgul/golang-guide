...
//BURADA DIREK PAKET ISMINI YADA MAIN ASAGIDAKI GIBI KULLANABLRZ
//BNDAN SONRAKILERDE IDE NE YAPIYORSA DEVAM ETCEM
...
func main() {
	...
	fmt.Printf("%T\n", name) //ver itipini yazdırmak
	fmt.Printf("%T\n", age)
	fmt.Printf("%T\n", isMarried)
	fmt.Printf("%T\n", weight)
	//kucuk veri tipleri daha az yer kaplar
}
