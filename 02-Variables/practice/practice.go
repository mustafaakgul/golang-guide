...
//Declation var studentName string  beyan etmek bir şey yapacagım
//assing = ile yapılan
//var studentName string = "John Doe" tanımlayıp deger atamk
...
func main() {
	...
	studentName := "John Doe" //declare ve assign together
	studentName = "Mahmut Erdem"

	fmt.Println(studentName)

	var x string = "a"
	//var x string = "b"  //burada aynı scope da aynı deger ataması yapılamaz
	fmt.Println(x)
